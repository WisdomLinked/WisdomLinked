...
export function Login() {
  ...
  const showLocalLogin = settings.loginMethods.local;
  const showDiscordLogin = settings.loginMethods.discord;
  const showDivider = showLocalLogin && showDiscordLogin;
      ...
      <div className="max-w-md mx-auto">
        <Card>
          ...
          <CardContent>
            ...
            {!showLocalLogin && !showDiscordLogin && (
              <div className="text-center text-sm text-gray-500">
                All login methods are currently disabled. Please contact the administrator.
              </div>
            )}
