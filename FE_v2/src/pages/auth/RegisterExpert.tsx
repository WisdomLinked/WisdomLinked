...
function hasErrors(errors: Step1Errors): boolean {
          ...
          {step.kind === "step1" ? (
            <>
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  Create your expert account. Our team will verify your
                ...
                <form onSubmit={handleStep1Submit} noValidate className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleStep1Change("username", e.target.value)
                      }
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        onChange={(e) =>
                          handleStep1Change("password", e.target.value)
                        }
